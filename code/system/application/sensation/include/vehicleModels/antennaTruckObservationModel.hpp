...
#ifndef ANTENNAOBSERVATIONMODEL_HPP_
#define ANTENNAOBSERVATIONMODEL_HPP_
...
namespace sensation {
namespace antennaTruckObservationModel
{
 ...
 */
template<typename T>
class antennaTruckObservationVector : public opendlv::system::libs::kalman::Vector<T, 4>
{
public:
    KALMAN_VECTOR(antennaTruckObservationVector, T, 4)
...
class antennaTruckObservationModel :
        public opendlv::system::libs::kalman::LinearizedMeasurementModel<opendlv::system::application::sensation::antennaTruckModel::State<T>,
               antennaTruckObservationVector<T>,
               CovarianceBase>
{
public :
    //! State type shortcut definition
    typedef opendlv::system::application::sensation::antennaTruckModel::State<T> S;

    //! Measurement type shortcut definition
    typedef antennaTruckObservationVector<T> M;
     ...
     */
    antennaTruckObservationModel(T _x, T _y, T _theta, T _theta_rate)
    {
...
#endif  /* ANTENNATRUCKOBSERVATIONMODEL_HPP_ */
